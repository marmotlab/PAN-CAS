...
class TSPEnv:
    ...
    def load_problems(self, batch_size, aug_factor=1):
        ...
        if aug_factor > 1:
            if aug_factor <= 512:
                ...
                self.instances = augment_xy_data_by_n_fold_3obj(self.instances)
            else:
    ...
    def _get_travel_distance(self):
        ...
        seq_expanded = self.instances[:, None, :, :].expand(self.batch_size, self.pomo_size, self.problem_size, 6)
