...
from MOCVRPTester_AS_IL_Neighbor import CVRPTester as Tester
...
tester_params = {
    ...
    'model_load': {
        'path': './result/train_cvrp_n50',  # directory path of pre-trained model and log files saved.
...
def main(n_sols=101):
    ...
    loaded_problem = load_dataset(
        '/home/yangyibin/hyperPMOCO/test_data/movrp/movrp%d_new_test_data_seed1234.pkl' % (problem_size))
    aug_score_list = []
    hv_list = []
