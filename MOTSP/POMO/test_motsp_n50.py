...
from MOTSProblemDef_hyper import get_random_problems
...
tester_params = {
    ...
    'model_load': {
        'path': './result/train__tsp_n50',  # directory path of pre-trained model and log files saved.
        'epoch': 200, 
    },
    'test_episodes': 200,
    'test_batch_size': 200,
...
def main(n_sols = 101):
    ...
    loaded_problem = load_dataset(
        '/home/qiang/Desktop/PMOCO-EAS/PMOCO/test_data/motsp/motsp%d_new_test_data_seed1234.pkl' % (problem_size))
